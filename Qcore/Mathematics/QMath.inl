//------------------------------------------------------------------------------------------------------------------
template <class Real>
Real Math<Real>::Min (Real fValue0, Real fValue1)
{
    return ( fValue0 < fValue1 ? fValue0 : fValue1 );
}
//------------------------------------------------------------------------------------------------------------------
template <class Real>
Real Math<Real>::Max (Real fValue0, Real fValue1)
{
    return ( fValue0 > fValue1 ? fValue0 : fValue1 );
}
//------------------------------------------------------------------------------------------------------------------
template <class Real>
Real Math<Real>::Min3 (Real fValue0, Real fValue1, Real fValue2)
{
    if ( fValue0 < fValue1 )
    {
        if ( fValue0 < fValue2 )
...
//------------------------------------------------------------------------------------------------------------------
template <class Real>
Real Math<Real>::Max3 (Real fValue0, Real fValue1, Real fValue2)
{
    if ( fValue0 > fValue1 )
    {
        if ( fValue0 > fValue2 )
...
//------------------------------------------------------------------------------------------------------------------
template <class Real>
void Math<Real>::MinMax (Real fValue0, Real fValue1, Real& rfMin, Real& rfMax)
{
    if ( fValue0 < fValue1 )
    {
        rfMin = fValue0;
...
//------------------------------------------------------------------------------------------------------------------
template <class Real>
void Math<Real>::MinMax3 (Real fValue0, Real fValue1, Real fValue2, Real& rfMin, Real& rfMax)
{
    if ( fValue0 < fValue1 )
    {
        rfMin = fValue0;
    ...
    if ( fValue2 < rfMin )
        rfMin = fValue2;
    else if ( fValue2 > rfMax )
        rfMax = fValue2;
}
//------------------------------------------------------------------------------------------------------------------
template <class Real>
int Math<Real>::RoundToInt (Real fValue)
{
    fValue += (Real)0.5;
    return (int)( fValue > (Real)0.0 ? fValue : floor(fValue) );
}
//------------------------------------------------------------------------------------------------------------------
template <class Real>
